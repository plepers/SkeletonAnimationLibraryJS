  ...
  (function (display) {
    ...
    var PixiDisplayBridge = (function () {
      ...
      PixiDisplayBridge.prototype.updateTransform = function (matrix, transform) {
        ...
        this._display.skewX = transform.skewX * PixiDisplayBridge.RADIAN_TO_ANGLE;
        this._display.skewY = transform.skewY * PixiDisplayBridge.RADIAN_TO_ANGLE;
    ...
    var PixiFactory = (function (_super) {
      ...
      PixiFactory.prototype._generateDisplay = function (textureAtlas, fullName, pivotX, pivotY) {
        ...
        if (rect) {
          ...
          PixiFactory._helpMatrix.a = 1;
          PixiFactory._helpMatrix.b = 0;
          PixiFactory._helpMatrix.c = 0;
          PixiFactory._helpMatrix.d = 1;
          PixiFactory._helpMatrix.scale(1 / textureAtlas.scale, 1 / textureAtlas.scale);
          PixiFactory._helpMatrix.tx = -pivotX - rect.x;
          PixiFactory._helpMatrix.ty = -pivotY - rect.y;
          shape.graphics.beginBitmapFill(textureAtlas.image, null, PixiFactory._helpMatrix);
          shape.graphics.drawRect(-pivotX, -pivotY, rect.width, rect.height);
        }
        return shape;
      };
      PixiFactory._helpMatrix = new createjs.Matrix2D(1, 0, 0, 1, 0, 0);
      return PixiFactory;
